...
class Cetak extends MY_Controller {
	...
	public function buku()
	{
		...
		if(!empty($cek) && $stts=='petugas')
		{
			...
			$tmp['content']=$this->load->view('petugas/cetak/R_buku',$data, TRUE);
...
public function cetak_kartu()
    {
        ...
        if(!empty($cek) && $stts=='petugas')
        {
            ...
            $tmp['content']=$this->load->view('petugas/cetak/R_kelas',$data, TRUE);
            $this->load->view('petugas/layout',$tmp);
        }
        else
        /*jika status login NO atau status bukan admin kembalikan ke login*/
	...
	public function barcode_buku()
	{
        ...
        $this->load->library('M_pdf');
            ...
            $data['data_buku'] = $this->Buku_model->getAllData("tb_buku");
            $this->load->view('petugas/cetak/cetak_barcode_buku',$data);
          ...
          //   $tmp=$this->load->view('petugas/cetak/cetak_barcode_buku',$data, TRUE);
	...
	public function barcode_kartu()
	{
        ...
        if(!empty($cek) && $stts=='petugas')
        {
            ...
            $this->load->view('petugas/cetak/cetak_kartu_anggota',$data);

...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
      <div class="col-md-12">
            <center> <h4 class="page-head-line">Selamat Datang Di Sistem Informasi Perpustakaan Kantor Imigrasi</h4></center>
      </div>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="header">Transaksi</li>
         <li class="treeview">
          ...
          <ul class="treeview-menu">
              <li><a href="<?php echo base_url(); ?>admin/Pinjam/vw_kembali"><i class="fa fa-book"></i>Data Pengembalian Buku</a></li>
              <li><a href="<?php echo base_url(); ?>admin/Pinjam/create"><i class="fa fa-book"></i>Tambah Data Peminjam</a></li>
              <li><a href="<?php echo base_url(); ?>admin/Pinjam"><i class="fa fa-book"></i>Data Peminjaman Buku</a></li>
        ...
        <li class="header">Cetak Data Buku</li>
        <li><a href="<?php echo base_url();?>admin/"><i class="fas fa-pen"></i><span>Print Data Buku</span></a></li>
      </ul>

...
<div class="box box-solid box-primary">
  ...
  <div class="form-group"></div>
	<form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>admin/Pinjam/create" role="form">
              <div class="box-body">
                ...
                <button type="submit" name="button" value="cek" class="btn btn-success"><i class="glyphicon glyphicon-file"></i> Data Peminjaman Anggota</button>
              </div>
                 <div class="form-group">
  ...
  <div class="box-footer">
    <td>
    <div align ="Right"> <a  href="<?php echo base_url(); ?>admin/Pinjam"  class="btn btn-danger" role="button" data-toggle="tooltip" title="Kembali"></i>Kembali</a></div>
  </td>
  </div>
  <div class="box-footer"> 
  </div><!-- box-footer -->
